...
public class OperatorEx1 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("계산중 후위형 num1 : "+
	            num1++);
	    System.out.println("계산후 후위형 num1 : "+
	            num1);
	    num1 = 10;
	    System.out.println("계산중 전위형 num1 : "+
	            ++num1);
	    /* 전위형 : 증가 후 동작(대입연산, 화면에 출력) ++증감연산자를 먼저 대입 ++num1 = "11"
	     * 후위형 : 동작 후 증가 ++증감연산자를 num1값을 먼저 화면에 출력후 대입 num1++ = "10"
	     * 결과는 같지만 화면출력에만 다르게 나옴
	     * */
	    /* 조건 선택연산자(삼항연산자)
	     * (조건식)?(값1):(값2)
	    ...
	    // 10 나누기 2가 0과 같다 참일시 "짝수" 출력 거짓일시 "홀수" 출력
	    /* 결합연산자 : 축양형
	     * num1 = num2 + 2; 축약전
	     * num1 += 2; 축약후
	     * num1 = num1 << 1;
